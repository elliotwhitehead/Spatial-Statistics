...
## - Lab: R Basics & How to Google

# R concepts: Packages #

## Packages ## 
##- like a lego pieces
##- \texttt{install.packages(`package')}
##                            - \texttt{library(`package')}
##- \texttt{help(`package')} for documentation
...
setwd('C:/Users/tchapman.TNC/Box/Chapman_managment/CUClasses/2022 Fall GEOG stats/Labs/Lab 3') 
